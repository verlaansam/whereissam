...
import { getFirestore, collection, addDoc, getDocs, limit, orderBy, query, updateDoc, deleteDoc, doc, getDoc, where } from "firebase/firestore";
...
export { auth, db, collection, addDoc, getDocs, limit, orderBy, query, updateDoc, deleteDoc, doc, getDoc, where };