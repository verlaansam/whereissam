  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-center bg-slate-950 text-gray-200">
      ...
      <form className="w-4/5 flex flex-col items-center" onSubmit={handleSignup}>
        ...
        <button aria-label="sign up" className="text-sm text-white font-roboto-slab border p-2 ml-4 w-3/4 hover:bg-white hover:text-black mt-4" type="submit">Sign Up</button>
      </form>
    </div>
  );
};
